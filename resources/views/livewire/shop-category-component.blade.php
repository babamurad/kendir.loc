<div class="nav-panel__departments">
    <!-- .departments -->
    <div class="departments" data-departments-fixed-by="" wire:ignore>
        <div class="departments__body">
            <div class="departments__links-wrapper" style="">
                <div class="departments__submenus-container">
                    <div class="departments__submenu departments__submenu--type--megamenu departments__submenu--size--xl" style="max-height: 754px;">
                        <!-- .megamenu -->
                    ...
                    <div class="departments__submenu departments__submenu--type--megamenu departments__submenu--size--lg" style="max-height: 754px;">
                        <!-- .megamenu -->
                        <div class="megamenu  megamenu--departments ">
                            <div class="megamenu__body" style="background-image: url('{{ asset('images/megamenu/megamenu-2.jpg') }}');">
                                <div class="row">
                                    <div class="col-4">
                                        <ul class="megamenu__links megamenu__links--level--0">
                                            <li class="megamenu__item  megamenu__item--with-submenu ">
                    ...
                    <div class="departments__submenu departments__submenu--type--megamenu departments__submenu--size--nl" style="max-height: 754px;">
                        <!-- .megamenu -->
                        <div class="megamenu  megamenu--departments ">
                ...
                <ul class="departments__links">
                    @foreach($categories as $category)
                        ...
                        <li class="departments__item">
                            <a class="departments__item-link" href="" wire:key="{{ $category->id }}">
                                {{ $category->name }}
                                        ...
                                        <ul class="menu__list">
                                            @foreach($category->children as $subcategory)
                                                <li class="menu__item">
                                                    ...
                                                    <a class="menu__item-link" href="{{ route('shop', ['id' => $subcategory->id]) }}" wire:key="{{ $subcategory->id }}">
                                                        {{ $subcategory->name }}
                                                    </a>
                                                </li>
                                            @endforeach
