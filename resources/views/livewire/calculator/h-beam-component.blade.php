<div>
    <h1 class="my-4 text-center" >{{__('calc.HBeam')}}</h1>
        ...
        <div class="row ">
                ...
                <div class="tab-content card" style="margin-top: -12px;">
                    <!-- Panel 1 -->                    <div class="tab-pane fade in active show" id="panel1" role="tabpanel">
                        ...
                        <div class="form-group">
                            <div class="row calc">
                                <label class="col-sm-6 control-label" for="height">{{__('calc.Height Hh')}} {{ __('calc.mm.') }}</label>
                                <div class="col-sm-6">
            ...
            <div class="col-sm-6 mb-4">
                <div class="card text-center">
                    <div class="card-img-top mt-2 p-3 h-50"><img src="{{ asset('images/calculator/dvutavr_calc.svg') }}" alt=""></div>
