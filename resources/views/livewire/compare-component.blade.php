                    ...
                    @foreach(\Gloudemans\Shoppingcart\Facades\Cart::instance('compare')->content() as $product)
                        <tr class="wishlist__row">
                            ...
                            <td class="wishlist__column wishlist__column--product">
                                <a href="{{ route('product.details', ['slug' => $product->model->slug]) }}" class="wishlist__product-name" wire:navigate>{{ $product->model->name }}</a>
                            ...
                            <td class="wishlist__column wishlist__column--stock">
                                <div class="badge badge-success">{{ $product->model->stock_status }}</div>
                            </td>
                            <td class="wishlist__column wishlist__column--price">{{ $product->model->sale_price }}</td>
                            <td class="wishlist__column wishlist__column--tocart">
                                <button type="button" class="btn btn-primary btn-sm" wire:click="store({{$product->model->id}}, '{{$product->model->name}}', {{ $product->model->sale_price }})">Add To Cart</button>
                            </td>
                            <td class="wishlist__column wishlist__column--remove">
                                <button type="button" class="btn btn-light btn-sm btn-svg-icon" wire:click="removeWishlist('{{ $product->id }}')">
