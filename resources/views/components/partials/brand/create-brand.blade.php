<div>
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="CreateBrand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{__('Create New Brand')}}</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button @click="$dispatch('brand-add')" type="button" class="btn btn-primary" wire:click='create'>Save changes</button>
                </div>
            </div>
        </div>
    </div>
